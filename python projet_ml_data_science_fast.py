...
class BreastCancerClassifier:
    ...
    def save_best_model(self, model_dir='models'):
        """Sauvegarde le meilleur modèle et les métriques"""
        ...
        # Convertir les métriques en format JSON-serializable
        json_metrics = {}
        for model_name, metrics in self.results.items():
            json_metrics[model_name] = {k: (v.tolist() if isinstance(v, np.ndarray) else v) 
